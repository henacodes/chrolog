...
const badgeVariants = cva(
  "inline-flex items-center rounded-lg border px-2.5 py-0.5 text-xs font-bold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        default:
          "border-transparent bg-[#65A30D] dark:bg-[#C6FE1E] text-white dark:text-slate-950 font-black shadow-sm",
        secondary:
        ...
        lime: "border-emerald-300 dark:border-[#C6FE1E]/40 bg-emerald-50 dark:bg-[#C6FE1E]/15 text-emerald-800 dark:text-[#C6FE1E] font-black",
      },
    },
    defaultVariants: {
      variant: "default",
